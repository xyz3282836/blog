import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as i,o as t,c as l,f as p,b as n,d as o,e as c,a as s}from"./app-F3T2sEmd.js";const r={},d=n("p",null,"Apache 是世界使用排名第一的 Web 服务器软件。它可以运行在几乎所有广泛使用的计算机平台上，由于其跨平台和安全性被广泛使用，是最流行的 Web 服务器端软件之一。它快速、可靠并且可通过简单的 API 扩充，将 Perl/Python 等解释器编译到服务器中。",-1),v=s('<h2 id="apache-是什么" tabindex="-1"><a class="header-anchor" href="#apache-是什么"><span>Apache 是什么</span></a></h2><p>Apache HTTP Server (简称 Apache )是 Apache 软件基金会的一个开放源码的网页服务器，可以在大多数计算机操作系统中运行，由于其多平台和安全性被广泛使用，是最流行的 Web 服务器端软件之一。它快速、可靠并且可通过简单的 API 扩展，将 Perl/Python 等解释器编译到服务器中。</p><p>Apache HTTP 服务器是一个模块化的服务器，源于 NCSAhttpd 服务器，经过多次修改，成为世界使用排名第一的 Web 服务器软件。<br> 它可以运行在几乎所有广泛使用的计算机平台上。</p><h2 id="apache-模块" tabindex="-1"><a class="header-anchor" href="#apache-模块"><span>Apache 模块</span></a></h2><p>Apache 通过引入各种模块来完成不同的功能。</p><h2 id="apache-官方文档" tabindex="-1"><a class="header-anchor" href="#apache-官方文档"><span>Apache 官方文档</span></a></h2>',6),u={href:"https://httpd.apache.org/docs/2.4/zh-cn/",target:"_blank",rel:"noopener noreferrer"},k=s(`<h2 id="apache-配置" tabindex="-1"><a class="header-anchor" href="#apache-配置"><span>Apache 配置</span></a></h2><p>Apache 通过 conf 文件夹下的 httpd.conf 来配置。</p><div class="language-apacheconf line-numbers-mode" data-ext="apacheconf" data-title="apacheconf"><pre class="language-apacheconf"><code><span class="token comment"># 此处填入 Apache 的路径</span>
