...
* d1be385 init hello
<span class="token punctuation">..</span>.
</code></pre></div><p>远程分支的提交历史也是一条直线。</p><h2 id="rebase-小结" tabindex="-1"><a class="header-anchor" href="#rebase-小结" aria-hidden="true">#</a> Rebase 小结</h2><ul><li><p><code>rebase</code> 操作可以把本地未 <code>push</code> 的分叉提交历史整理成直线；</p></li><li><p><code>rebase</code> 的目的是使得我们在查看历史提交的变化时更容易，因为分叉的提交需要三方对比。</p></li></ul>`,139);function A(x,w){const a=p("Mermaid");return e(),t("div",null,[h,o(a,{id:"mermaid-300",code:""}),f])}const D=s(v,[["render",A],["__file","branch.html.vue"]]);export{D as default};
