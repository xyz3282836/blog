import{_ as t}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as c,o,c as p,f as l,b as s,d as n,e as i,w as u,a}from"./app-5SN1Q1t2.js";const d={},r=s("p",null,"本章介绍如何对 Shell 脚本除错。",-1),k=a(`<h2 id="常见错误" tabindex="-1"><a class="header-anchor" href="#常见错误"><span>常见错误</span></a></h2><p>编写 Shell 脚本的时候，一定要考虑到命令失败的情况，否则很容易出错。</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token shebang important">#! /bin/bash</span>
...
Number is equal to <span class="token number">1</span>.
</code></pre></div>`,26),h=s("code",null,"set",-1),b=a(`<h2 id="环境变量" tabindex="-1"><a class="header-anchor" href="#环境变量"><span>环境变量</span></a></h2><p>有一些环境变量常用于除错。</p><h3 id="lineno" tabindex="-1"><a class="header-anchor" href="#lineno"><span>LINENO</span></a></h3><p>变量 <code>LINENO</code> 返回它在脚本里面的行号。</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
</code></pre></div><p>上面例子中，函数 <code>func1</code> 是在 <code>main.sh</code> 的第 7 行调用，函数 <code>func2</code> 是在 <code>lib1.sh</code> 的第 8 行调用的。</p>`,33);function m(v,g){const e=c("RouterLink");return o(),p("div",null,[r,l(" more "),k,s("p",null,[n("另外，"),h,n(" 命令也可以设置 Shell 的行为参数，有利于脚本除错，详见 "),i(e,{to:"/linux/bash/set.html"},{default:u(()=>[n("set 命令")]),_:1}),n(" 一章。")]),b])}const E=t(d,[["render",m],["__file","debug.html.vue"]]);export{E as default};
