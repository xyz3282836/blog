...
Number is equal to <span class="token number">1</span>.
</code></pre></div>`,26),k=s("code",null,"set",-1),b=a(`<h2 id="环境变量" tabindex="-1"><a class="header-anchor" href="#环境变量"><span>环境变量</span></a></h2><p>有一些环境变量常用于除错。</p><h3 id="lineno" tabindex="-1"><a class="header-anchor" href="#lineno"><span>LINENO</span></a></h3><p>变量 <code>LINENO</code> 返回它在脚本里面的行号。</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
</code></pre></div><p>上面例子中，函数 <code>func1</code> 是在 <code>main.sh</code> 的第 7 行调用，函数 <code>func2</code> 是在 <code>lib1.sh</code> 的第 8 行调用的。</p>`,33);function m(g,v){const e=c("RouteLink");return o(),p("div",null,[r,l(" more "),h,s("p",null,[n("另外，"),k,n(" 命令也可以设置 Shell 的行为参数，有利于脚本除错，详见 "),i(e,{to:"/linux/bash/set.html"},{default:u(()=>[n("set 命令")]),_:1}),n(" 一章。")]),b])}const _=t(d,[["render",m],["__file","debug.html.vue"]]),S=JSON.parse('{"path":"/linux/bash/debug.html","title":"脚本除错","lang":"zh-CN","frontmatter":{"date":"2020-05-04T00:00:00.000Z","title":"脚本除错","icon":"debug","author":"阮一峰","category":"Linux","tag":["Bash"],"copyright":"本教程采用<a href=\\"https://creativecommons.org/licenses/by-sa/3.0/deed.zh\\" rel=\\"noopener noreferrer\\" target=\\"_blank\\">知识共享 署名-相同方式共享 3.0协议</a>","description":"本章介绍如何对 Shell 脚本除错。 常见错误 编写 Shell 脚本的时候，一定要考虑到命令失败的情况，否则很容易出错。 上面脚本中，如果目录 $dir_name 不存在，cd $dir_name 命令就会执行失败。这时，就不会改变当前目录，脚本会继续执行下去，导致 rm * 命令删光当前目录的文件。 如果改成下面的样子，也会有问题。 上面脚本中，...","head":[["meta",{"property":"og:url","content":"https://blog.ruizhou.cf/linux/bash/debug.html"}],["meta",{"property":"og:site_name","content":"rz blog"}],["meta",{"property":"og:title","content":"脚本除错"}],["meta",{"property":"og:description","content":"本章介绍如何对 Shell 脚本除错。 常见错误 编写 Shell 脚本的时候，一定要考虑到命令失败的情况，否则很容易出错。 上面脚本中，如果目录 $dir_name 不存在，cd $dir_name 命令就会执行失败。这时，就不会改变当前目录，脚本会继续执行下去，导致 rm * 命令删光当前目录的文件。 如果改成下面的样子，也会有问题。 上面脚本中，..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-01-19T19:40:22.000Z"}],["meta",{"property":"article:author","content":"阮一峰"}],["meta",{"property":"article:tag","content":"Bash"}],["meta",{"property":"article:published_time","content":"2020-05-04T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-01-19T19:40:22.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"脚本除错\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2020-05-04T00:00:00.000Z\\",\\"dateModified\\":\\"2024-01-19T19:40:22.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"阮一峰\\"}]}"]]},"headers":[{"level":2,"title":"常见错误","slug":"常见错误","link":"#常见错误","children":[]},{"level":2,"title":"bash 的 -x 参数","slug":"bash-的-x-参数","link":"#bash-的-x-参数","children":[]},{"level":2,"title":"环境变量","slug":"环境变量","link":"#环境变量","children":[{"level":3,"title":"LINENO","slug":"lineno","link":"#lineno","children":[]},{"level":3,"title":"FUNCNAME","slug":"funcname","link":"#funcname","children":[]},{"level":3,"title":"BASH_SOURCE","slug":"bash-source","link":"#bash-source","children":[]},{"level":3,"title":"BASH_LINENO","slug":"bash-lineno","link":"#bash-lineno","children":[]}]}],"git":{"createdTime":1705693222000,"updatedTime":1705693222000,"contributors":[{"name":"zhou","email":"ruizhou@163.com","commits":1}]},"readingTime":{"minutes":4.39,"words":1318},"filePathRelative":"linux/bash/debug.md","localizedDate":"2020年5月4日","excerpt":"<p>本章介绍如何对 Shell 脚本除错。</p>\\n","copyright":{"author":"阮一峰"},"autoDesc":true}');export{_ as comp,S as data};
