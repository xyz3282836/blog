...
$ <span class="token function">ls</span> **/*.txt
a.txt  sub1/b.txt  sub1/sub2/c.txt
</code></pre></div></li></ol><h2 id="参考链接" tabindex="-1"><a class="header-anchor" href="#参考链接" aria-hidden="true">#</a> 参考链接</h2>`,57),m={href:"https://medium.com/@leedowthwaite/why-most-people-only-think-they-understand-wildcards-63bb9c2024ab",target:"_blank",rel:"noopener noreferrer"},x={href:"https://appcodelabs.com/advanced-wildcard-patterns-most-people-dont-know",target:"_blank",rel:"noopener noreferrer"};function v($,f){const c=o("RouterLink"),t=o("ExternalLinkIcon");return d(),i("div",null,[r,s("p",null,[a("Bash 将美元符号 "),b,a(" 开头的词元视为变量，将其扩展成变量值，详见"),n(c,{to:"/linux/bash/variable.html"},{default:p(()=>[a("Bash 变量")]),_:1}),a(" 一章。")]),h,s("p",null,[k,a(" 可以扩展成整数运算的结果，详见 "),n(c,{to:"/linux/bash/arithmetic.html"},{default:p(()=>[a("Bash 的算术运算")]),_:1}),a(" 一章。")]),g,s("ul",null,[s("li",null,[s("a",m,[a("Think You Understand Wildcards? Think Again"),n(t)])]),s("li",null,[s("a",x,[a("Advanced Wildcard Patterns Most People Don’t Know"),n(t)])])])])}const w=l(u,[["render",v],["__file","expansion.html.vue"]]);export{w as default};
