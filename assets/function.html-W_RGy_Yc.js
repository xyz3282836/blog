...
</code></pre></div><p>上面例子中，<code>local</code> 命令声明的 <code>$foo</code> 变量，只在函数体内有效，函数体外没有定义。</p><h2 id="参考链接" tabindex="-1"><a class="header-anchor" href="#参考链接"><span>参考链接</span></a></h2>`,57),k={href:"https://www.linuxtechi.com/define-use-functions-linux-shell-script/",target:"_blank",rel:"noopener noreferrer"};function h(b,g){const n=t("ExternalLinkIcon");return o(),p("div",null,[u,c(" more "),r,a("ul",null,[a("li",null,[a("a",k,[s("How to define and use functions in Linux Shell Script"),l(n)]),s(", by Pradeep Kumar")])])])}const v=e(d,[["render",h],["__file","function.html.vue"]]);export{v as default};
