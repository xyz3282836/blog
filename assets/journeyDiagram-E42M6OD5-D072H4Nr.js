...
`+this.showPosition(),{text:"",token:null,line:this.yylineno})},"next"),lex:a(function(){var i=this.next();return i||this.lex()},"lex"),begin:a(function(i){this.conditionStack.push(i)},"begin"),popState:a(function(){var i=this.conditionStack.length-1;return i>0?this.conditionStack.pop():this.conditionStack[0]},"popState"),_currentRules:a(function(){return this.conditionStack.length&&this.conditionStack[this.conditionStack.length-1]?this.conditions[this.conditionStack[this.conditionStack.length-1]].rules:this.conditions.INITIAL.rules},"_currentRules"),topState:a(function(i){return i=this.conditionStack.length-1-Math.abs(i||0),i>=0?this.conditionStack[i]:"INITIAL"},"topState"),pushState:a(function(i){this.begin(i)},"pushState"),stateStackSize:a(function(){return this.conditionStack.length},"stateStackSize"),options:{"case-insensitive":!0},performAction:a(function(i,r,u,p){switch(u){case 0:break;case 1:break;case 2:return 10;case 3:break;case 4:break;case 5:return 4;case 6:return 11;case 7:return this.begin("acc_title"),12;case 8:return this.popState(),"acc_title_value";case 9:return this.begin("acc_descr"),14;case 10:return this.popState(),"acc_descr_value";case 11:this.begin("acc_descr_multiline");break;case 12:this.popState();break;case 13:return"acc_descr_multiline_value";case 14:return 17;case 15:return 18;case 16:return 19;case 17:return":";case 18:return 6;case 19:return"INVALID"}},"anonymous"),rules:[/^(?:%(?!\{)[^\n]*)/i,/^(?:[^\}]%%[^\n]*)/i,/^(?:[\n]+)/i,/^(?:\s+)/i,/^(?:#[^\n]*)/i,/^(?:journey\b)/i,/^(?:title\s[^#\n;]+)/i,/^(?:accTitle\s*:\s*)/i,/^(?:(?!\n||)*[^\n]*)/i,/^(?:accDescr\s*:\s*)/i,/^(?:(?!\n||)*[^\n]*)/i,/^(?:accDescr\s*\{\s*)/i,/^(?:[\}])/i,/^(?:[^\}]*)/i,/^(?:section\s[^#:\n;]+)/i,/^(?:[^#:\n;]+)/i,/^(?::[^#\n;]+)/i,/^(?::)/i,/^(?:$)/i,/^(?:.)/i],conditions:{acc_descr_multiline:{rules:[12,13],inclusive:!1},acc_descr:{rules:[10],inclusive:!1},acc_title:{rules:[8],inclusive:!1},INITIAL:{rules:[0,1,2,3,4,5,6,7,9,11,14,15,16,17,18,19],inclusive:!0}}};return y}();f.lexer=m;function g(){this.yy={}}return a(g,"Parser"),g.prototype=f,f.Parser=g,new g}();Z.parser=Z;var Ct=Z,B="",H=[],R=[],O=[],At=a(function(){H.length=0,R.length=0,B="",O.length=0,Tt()},"clear"),It=a(function(t){B=t,H.push(t)},"addSection"),Pt=a(function(){return H},"getSections"),jt=a(function(){let t=it(),e=100,s=0;for(;!t&&s<e;)t=it(),s++;return R.push(...O),R},"getTasks"),Bt=a(function(){let t=[];return R.forEach(e=>{e.people&&t.push(...e.people)}),[...new Set(t)].sort()},"updateActors"),Lt=a(function(t,e){let s=e.substr(1).split(":"),l=0,n=[];s.length===1?(l=Number(s[0]),n=[]):(l=Number(s[0]),n=s[1].split(","));let c=n.map(h=>h.trim()),d={section:B,type:B,people:c,task:t,score:l};O.push(d)},"addTask"),Rt=a(function(t){let e={section:B,type:B,description:t,task:t,classes:[]};R.push(e)},"addTaskOrg"),it=a(function(){let t=a(function(s){return O[s].processed},"compileTask"),e=!0;for(let[s,l]of O.entries())t(s),e=e&&l.processed;return e},"compileTasks"),Ot=a(function(){return Bt()},"getActors"),nt={getConfig:a(()=>L().journey,"getConfig"),clear:At,setDiagramTitle:Mt,getDiagramTitle:St,setAccTitle:$t,getAccTitle:wt,setAccDescription:vt,getAccDescription:_t,addSection:It,getSections:Pt,getTasks:jt,addTask:Lt,addTaskOrg:Rt,getActors:Ot},Nt=a(t=>`.label {
  ...
  ${bt()}
`,"getStyles"),Vt=Nt,Q=a(function(t,e){return kt(t,e)},"drawRect"),Ft=a(function(t,e){let s=t.append("circle").attr("cx",e.cx).attr("cy",e.cy).attr("class","face").attr("r",15).attr("stroke-width",2).attr("overflow","visible"),l=t.append("g");l.append("circle").attr("cx",e.cx-15/3).attr("cy",e.cy-15/3).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666"),l.append("circle").attr("cx",e.cx+15/3).attr("cy",e.cy-15/3).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666");function n(h){let f=et().startAngle(Math.PI/2).endAngle(3*(Math.PI/2)).innerRadius(7.5).outerRadius(6.8181818181818175);h.append("path").attr("class","mouth").attr("d",f).attr("transform","translate("+e.cx+","+(e.cy+2)+")")}a(n,"smile");function c(h){let f=et().startAngle(3*Math.PI/2).endAngle(5*(Math.PI/2)).innerRadius(7.5).outerRadius(6.8181818181818175);h.append("path").attr("class","mouth").attr("d",f).attr("transform","translate("+e.cx+","+(e.cy+7)+")")}a(c,"sad");function d(h){h.append("line").attr("class","mouth").attr("stroke",2).attr("x1",e.cx-5).attr("y1",e.cy+7).attr("x2",e.cx+5).attr("y2",e.cy+7).attr("class","mouth").attr("stroke-width","1px").attr("stroke","#666")}return a(d,"ambivalent"),e.score>3?n(l):e.score<3?c(l):d(l),s},"drawFace"),lt=a(function(t,e){let s=t.append("circle");return s.attr("cx",e.cx),s.attr("cy",e.cy),s.attr("class","actor-"+e.pos),s.attr("fill",e.fill),s.attr("stroke",e.stroke),s.attr("r",e.r),s.class!==void 0&&s.attr("class",s.class),e.title!==void 0&&s.append("title").text(e.title),s},"drawCircle"),ct=a(function(t,e){return xt(t,e)},"drawText"),Dt=a(function(t,e){function s(n,c,d,h,f){return n+","+c+" "+(n+d)+","+c+" "+(n+d)+","+(c+h-f)+" "+(n+d-f*1.2)+","+(c+h)+" "+n+","+(c+h)}a(s,"genPoints");let l=t.append("polygon");l.attr("points",s(e.x,e.y,50,20,7)),l.attr("class","labelBox"),e.y=e.y+e.labelMargin,e.x=e.x+.5*e.labelMargin,ct(t,e)},"drawLabel"),zt=a(function(t,e,s){let l=t.append("g"),n=ot();n.x=e.x,n.y=e.y,n.fill=e.fill,n.width=s.width*e.taskCount+s.diagramMarginX*(e.taskCount-1),n.height=s.height,n.class="journey-section section-type-"+e.num,n.rx=3,n.ry=3,Q(l,n),ht(s)(e.text,l,n.x,n.y,n.width,n.height,{class:"journey-section section-type-"+e.num},s,e.colour)},"drawSection"),at=-1,qt=a(function(t,e,s){let l=e.x+s.width/2,n=t.append("g");at++,n.append("line").attr("id","task"+at).attr("x1",l).attr("y1",e.y).attr("x2",l).attr("y2",450).attr("class","task-line").attr("stroke-width","1px").attr("stroke-dasharray","4 2").attr("stroke","#666"),Ft(n,{cx:l,cy:300+(5-e.score)*30,score:e.score});let c=ot();c.x=e.x,c.y=e.y,c.fill=e.fill,c.width=s.width,c.height=s.height,c.class="task task-type-"+e.num,c.rx=3,c.ry=3,Q(n,c);let d=e.x+14;e.people.forEach(h=>{let f=e.actors[h].color,m={cx:d,cy:e.y,r:7,fill:f,stroke:"#000",title:h,pos:e.actors[h].position};lt(n,m),d+=10}),ht(s)(e.task,n,c.x,c.y,c.width,c.height,{class:"task"},s,e.colour)},"drawTask"),Gt=a(function(t,e){mt(t,e)},"drawBackgroundRect"),ht=function(){function t(n,c,d,h,f,m,g,y){let i=c.append("text").attr("x",d+f/2).attr("y",h+m/2+5).style("font-color",y).style("text-anchor","middle").text(n);l(i,g)}a(t,"byText");function e(n,c,d,h,f,m,g,y,i){let{taskFontSize:r,taskFontFamily:u}=y,p=n.split(/<br\s*\/?>/gi);for(let o=0;o<p.length;o++){let x=o*r-r*(p.length-1)/2,k=c.append("text").attr("x",d+f/2).attr("y",h).attr("fill",i).style("text-anchor","middle").style("font-size",r).style("font-family",u);k.append("tspan").attr("x",d+f/2).attr("dy",x).text(p[o]),k.attr("y",h+m/2).attr("dominant-baseline","central").attr("alignment-baseline","central"),l(k,g)}}a(e,"byTspan");function s(n,c,d,h,f,m,g,y){let i=c.append("switch"),r=i.append("foreignObject").attr("x",d).attr("y",h).attr("width",f).attr("height",m).attr("position","fixed").append("xhtml:div").style("display","table").style("height","100%").style("width","100%");r.append("div").attr("class","label").style("display","table-cell").style("text-align","center").style("vertical-align","middle").text(n),e(n,i,d,h,f,m,g,y),l(r,g)}a(s,"byFo");function l(n,c){for(let d in c)d in c&&n.attr(d,c[d])}return a(l,"_setTextAttrs"),function(n){return n.textPlacement==="fo"?s:n.textPlacement==="old"?t:e}}(),Ut=a(function(t){t.append("defs").append("marker").attr("id","arrowhead").attr("refX",5).attr("refY",2).attr("markerWidth",6).attr("markerHeight",4).attr("orient","auto").append("path").attr("d","M 0,0 V 4 L6,2 Z")},"initGraphics"),N={drawRect:Q,drawCircle:lt,drawSection:zt,drawText:ct,drawLabel:Dt,drawTask:qt,drawBackgroundRect:Gt,initGraphics:Ut},Wt=a(function(t){Object.keys(t).forEach(function(e){S[e]=t[e]})},"setConf"),E={},D=0;function ut(t){let e=L().journey,s=e.maxLabelWidth;D=0;let l=60;Object.keys(E).forEach(n=>{let c=E[n].color,d={cx:20,cy:l,r:7,fill:c,stroke:"#000",pos:E[n].position};N.drawCircle(t,d);let h=t.append("text").attr("visibility","hidden").text(n),f=h.node().getBoundingClientRect().width;h.remove();let m=[];if(f<=s)m=[n];else{let g=n.split(" "),y="";h=t.append("text").attr("visibility","hidden"),g.forEach(i=>{let r=y?`${y} ${i}`:i;if(h.text(r),h.node().getBoundingClientRect().width>s){if(y&&m.push(y),y=i,h.text(i),h.node().getBoundingClientRect().width>s){let u="";for(let p of i)u+=p,h.text(u+"-"),h.node().getBoundingClientRect().width>s&&(m.push(u.slice(0,-1)+"-"),u=p);y=u}}else y=r}),y&&m.push(y),h.remove()}m.forEach((g,y)=>{let i={x:40,y:l+7+y*20,fill:"#666",text:g,textMargin:e.boxTextMargin??5},r=N.drawText(t,i).node().getBoundingClientRect().width;r>D&&r>e.leftMargin-r&&(D=r)}),l+=Math.max(20,m.length*20)})}a(ut,"drawActorLegend");var S=L().journey,T=0,Yt=a(function(t,e,s,l){let n=L(),c=n.journey.titleColor,d=n.journey.titleFontSize,h=n.journey.titleFontFamily,f=n.securityLevel,m;f==="sandbox"&&(m=Y("#i"+e));let g=f==="sandbox"?Y(m.nodes()[0].contentDocument.body):Y("body");$.init();let y=g.select("#"+e);N.initGraphics(y);let i=l.db.getTasks(),r=l.db.getDiagramTitle(),u=l.db.getActors();for(let P in E)delete E[P];let p=0;u.forEach(P=>{E[P]={color:S.actorColours[p%S.actorColours.length],position:p},p++}),ut(y),T=S.leftMargin+D,$.insert(0,0,T,Object.keys(E).length*50),Xt(y,i,0);let o=$.getBounds();r&&y.append("text").text(r).attr("x",T).attr("font-size",d).attr("font-weight","bold").attr("y",25).attr("fill",c).attr("font-family",h);let x=o.stopy-o.starty+2*S.diagramMarginY,k=T+o.stopx+2*S.diagramMarginX;Et(y,x,k,S.useMaxWidth),y.append("line").attr("x1",T).attr("y1",S.height*4).attr("x2",k-T-4).attr("y2",S.height*4).attr("stroke-width",4).attr("stroke","black").attr("marker-end","url(#arrowhead)");let C=r?70:0;y.attr("viewBox",`${o.startx} -25 ${k} ${x+C}`),y.attr("preserveAspectRatio","xMinYMin meet"),y.attr("height",x+C+25)},"draw"),$={data:{startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},verticalPos:0,sequenceItems:[],init:a(function(){this.sequenceItems=[],this.data={startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},this.verticalPos=0},"init"),updateVal:a(function(t,e,s,l){t[e]===void 0?t[e]=s:t[e]=l(s,t[e])},"updateVal"),updateBounds:a(function(t,e,s,l){let n=L().journey,c=this,d=0;function h(f){return a(function(m){d++;let g=c.sequenceItems.length-d+1;c.updateVal(m,"starty",e-g*n.boxMargin,Math.min),c.updateVal(m,"stopy",l+g*n.boxMargin,Math.max),c.updateVal($.data,"startx",t-g*n.boxMargin,Math.min),c.updateVal($.data,"stopx",s+g*n.boxMargin,Math.max),f!=="activation"&&(c.updateVal(m,"startx",t-g*n.boxMargin,Math.min),c.updateVal(m,"stopx",s+g*n.boxMargin,Math.max),c.updateVal($.data,"starty",e-g*n.boxMargin,Math.min),c.updateVal($.data,"stopy",l+g*n.boxMargin,Math.max))},"updateItemBounds")}a(h,"updateFn"),this.sequenceItems.forEach(h())},"updateBounds"),insert:a(function(t,e,s,l){let n=Math.min(t,s),c=Math.max(t,s),d=Math.min(e,l),h=Math.max(e,l);this.updateVal($.data,"startx",n,Math.min),this.updateVal($.data,"starty",d,Math.min),this.updateVal($.data,"stopx",c,Math.max),this.updateVal($.data,"stopy",h,Math.max),this.updateBounds(n,d,c,h)},"insert"),bumpVerticalPos:a(function(t){this.verticalPos=this.verticalPos+t,this.data.stopy=this.verticalPos},"bumpVerticalPos"),getVerticalPos:a(function(){return this.verticalPos},"getVerticalPos"),getBounds:a(function(){return this.data},"getBounds")},X=S.sectionFills,rt=S.sectionColours,Xt=a(function(t,e,s){let l=L().journey,n="",c=l.height*2+l.diagramMarginY,d=s+c,h=0,f="#CCC",m="black",g=0;for(let[y,i]of e.entries()){if(n!==i.section){f=X[h%X.length],g=h%X.length,m=rt[h%rt.length];let u=0,p=i.section;for(let x=y;x<e.length&&e[x].section==p;x++)u=u+1;let o={x:y*l.taskMargin+y*l.width+T,y:50,text:i.section,fill:f,num:g,colour:m,taskCount:u};N.drawSection(t,o,l),n=i.section,h++}let r=i.people.reduce((u,p)=>(E[p]&&(u[p]=E[p]),u),{});i.x=y*l.taskMargin+y*l.width+T,i.y=d,i.width=l.diagramMarginX,i.height=l.diagramMarginY,i.colour=m,i.fill=f,i.num=g,i.actors=r,N.drawTask(t,i,l),$.insert(i.x,i.y,i.x+i.width+l.taskMargin,450)}},"drawTasks"),st={setConf:Wt,draw:Yt},te={parser:Ct,db:nt,renderer:st,styles:Vt,init:a(t=>{st.setConf(t.journey),nt.clear()},"init")};export{te as diagram};
