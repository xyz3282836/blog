import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as o,o as p,c,f as t,b as s,d as n,e as l,a as i}from"./app-qZXhpeuI.js";const d={},r=s("p",null,[n("Bash 提供三种循环语法 "),s("code",null,"for"),n("、"),s("code",null,"while"),n(" 和 "),s("code",null,"until"),n("。")],-1),k=i(`<h2 id="while-循环" tabindex="-1"><a class="header-anchor" href="#while-循环" aria-hidden="true">#</a> while 循环</h2><p><code>while</code> 循环有一个判断条件，只要符合条件，就不断循环执行指定的语句。</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token keyword">while</span> condition<span class="token punctuation">;</span> <span class="token keyword">do</span>
  commands
