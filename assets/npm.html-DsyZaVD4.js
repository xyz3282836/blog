import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as a,c as e,f as p,b as n,a as t}from"./app-B0-sQQPX.js";const o={},i=n("p",null,"从小程序基础库版本 2.2.1 或以上、及开发者工具 1.02.1808300 或以上开始，小程序支持使用 npm 安装第三方包。",-1),c=n("p",null,"此文档要求开发者们对 npm 有一定的了解，因此不会再去介绍 npm 的基本功能。如若之前未接触过 npm，请翻阅官方 npm 文档进行学习。",-1),l=t(`<h2 id="使用-npm-包" tabindex="-1"><a class="header-anchor" href="#使用-npm-包"><span>使用 npm 包</span></a></h2><ol><li><p>在小程序中执行命令安装 npm 包:</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span>
