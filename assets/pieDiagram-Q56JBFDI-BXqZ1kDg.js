import{c as Q}from"./chunk-4KE642ED-DJGuA-kF.js";import{p as V}from"./radar-MK3ICKWK-KPFLJ5ZN-CTsM3tVX.js";import{m as r,F as G,B as K,w as X,v as Y,c as j,b as q,t as y,H as I,n as J,aN as U,aP as Z,aQ as M,aR as _,T as ee,h as te,aS as ae,p as ie}from"./mermaid.esm.min-D43g8yP1.js";import"./chunk-5ZJXQJOJ-DGarbEid.js";import"./app-Cbhc7UI4.js";var re=ie.pie,T={sections:new Map,showData:!1},u=T.sections,D=T.showData,le=structuredClone(re),se=r(()=>structuredClone(le),"getConfig"),oe=r(()=>{u=new Map,D=T.showData,te()},"clear"),ne=r(({label:e,value:a})=>{u.has(e)||(u.set(e,a),y.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),pe=r(()=>u,"getSections"),de=r(e=>{D=e},"setShowData"),ce=r(()=>D,"getShowData"),O={getConfig:se,clear:oe,setDiagramTitle:q,getDiagramTitle:j,setAccTitle:Y,getAccTitle:X,setAccDescription:K,getAccDescription:G,addSection:ne,getSections:pe,setShowData:de,getShowData:ce},fe=r((e,a)=>{Q(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),ge={parse:r(async e=>{let a=await V("pie",e);y.debug(a),fe(a,O)},"parse")},me=r(e=>`
  .pieCircle{
