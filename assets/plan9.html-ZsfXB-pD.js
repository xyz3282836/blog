import{_ as t}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as l,o as d,c,b as n,d as s,e,a as i}from"./app-B0-sQQPX.js";const o="/assets/image-20220709144517363-Cgl38RnB.png",u={},r=n("h2",{id:"基本指令",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#基本指令"},[n("span",null,"基本指令")])],-1),p={href:"https://go.xargin.com/docs/assembly/assembly/",target:"_blank",rel:"noopener noreferrer"},v=i(`<ul><li>MOV 数据搬运，赋值</li><li>LEA 取址 &amp;</li><li>TEST</li><li>CMP 比较</li><li>JLS （ jump less ）小于时跳转</li><li>JMP（ jump ）无条件跳转</li><li>JEQ（ jump equal ）等于时跳转</li><li>SUB 相减，结果保存到目标操作数</li><li>ADD 相加，结果保存到目标操作数</li><li>RET 返回</li><li>NOP 空指令</li><li>CALL 调用函数</li><li>SHL（ shift logical left ） 逻辑左移指令 <code>&lt;&lt;</code></li><li>SHR（ shift logical right ） 逻辑右移指令 <code>&gt;&gt;</code>，右移时不保留操作数的符号，用 0 代替</li><li>SAL（ shift arithmetic left ）算术左移指令</li><li>SAR（ shift arithmetic right ）算术右移指令，右移时保留操作数的符号</li><li>XADD：交换并相加</li><li>NEG：求补指令，就是取相反数</li><li>XORPS：源操作数（第二个操作数）与目标操作数（第一个操作数）进行异或。结果保存到目标操作数</li><li>MOVUPS：与 MOV 一样，操作对象的类型不一样，这里是包含四个压缩单精度浮点值的双四字</li><li>XCHG: 交换两个操作数内容，自带 LOCK 总线锁属性</li></ul><blockquote><p>MOV 指令有有好几种后缀 MOVB MOVW MOVL MOVQ 分别对应的是 1 字节 、2 字节 、4 字节、8 字节</p></blockquote><h3 id="栈调整" tabindex="-1"><a class="header-anchor" href="#栈调整"><span>栈调整</span></a></h3><p>intel 或 AT&amp;T 汇编提供了 push 和 pop 指令族，<s>plan9 中没有 push 和 pop</s>，plan9 中虽然有 push 和 pop 指令，但一般生成的代码中是没有的，我们看到的栈的调整大多是通过对硬件 SP 寄存器进行运算来实现的，例如:</p><div class="language-asm" data-ext="asm" data-title="asm"><pre class="language-asm"><code>SUBQ $0x18, SP // 对 SP 做减法，为函数分配函数栈帧
...               // 省略无用代码
ADDQ $0x18, SP // 对 SP 做加法，清除函数栈帧
</code></pre></div><p>通用的指令和 X64 平台差不多，下面分节详述。</p><p>常数在 plan9 汇编用 $num 表示，可以为负数，默认情况下为十进制。可以用 $0x123 的形式来表示十六进制数。</p><h3 id="数据计算" tabindex="-1"><a class="header-anchor" href="#数据计算"><span>数据计算</span></a></h3><p>data moves from left to right</p><div class="language-asm" data-ext="asm" data-title="asm"><pre class="language-asm"><code>ADD R1, R2 // R2 += R1
SUB R3, R4, R5 // R5 = R4 - R3
MUL $7, R6 // R6 *= 7
</code></pre></div><h3 id="内存操作" tabindex="-1"><a class="header-anchor" href="#内存操作"><span>内存操作</span></a></h3><p>memory oprands: offset + reg1 + reg2*scale</p><p><code>(AX)</code>表示 <code>*AX</code>，取地址对应的值</p><div class="language-asm" data-ext="asm" data-title="asm"><pre class="language-asm"><code>MOV (R1), R2 // R2 = *R1  取R1的地址对应的值
MOV 8(R3), R4 // R4 = *(8 + R3)
...
</code></pre></div><h3 id="条件调转" tabindex="-1"><a class="header-anchor" href="#条件调转"><span>条件调转</span></a></h3><div class="language-asm" data-ext="asm" data-title="asm"><pre class="language-asm"><code>// 跳转
JMP addr
JMP label
JMP 2(PC)
JMP -2(PC)
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>flag 还可以是</p><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token comment">// Don&#39;t profile the marked routine. This flag is deprecated.过期了，给TEXT用的</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当使用这些 flag 的字面量时，需要在汇编文件中 <code>#include &quot;textflag.h&quot;</code>。</p><p>.s 文件可以读取.go 文件中的变量，以及.go 定义一个 func，.s 来实现这个 func，必须在一个包文件目录下，go build，go test 都是可以的</p><h2 id="函数声明" tabindex="-1"><a class="header-anchor" href="#函数声明"><span>函数声明</span></a></h2><div class="language-asm line-numbers-mode" data-ext="asm" data-title="asm"><pre class="language-asm"><code>// func add(a, b int) int
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="栈结构" tabindex="-1"><a class="header-anchor" href="#栈结构"><span>栈结构</span></a></h2><p>下面是一个典型的函数的栈结构图:</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>                       -----------------
                       current func arg0
                       ----------------- &lt;----------- FP(pseudo FP)
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>实例</p><p>go</p><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>asm</p><div class="language-asm line-numbers-mode" data-ext="asm" data-title="asm"><pre class="language-asm"><code>#include &quot;textflag.h&quot; // 因为我们声明函数用到了 NOSPLIT 这样的 flag，所以需要将 textflag.h 包含进来
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="伪寄存器-sp-、伪寄存器-fp-和硬件寄存器-sp" tabindex="-1"><a class="header-anchor" href="#伪寄存器-sp-、伪寄存器-fp-和硬件寄存器-sp"><span>伪寄存器 SP 、伪寄存器 FP 和硬件寄存器 SP</span></a></h3><p>todo</p><h3 id="其他" tabindex="-1"><a class="header-anchor" href="#其他"><span>其他</span></a></h3><p>go</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>type address struct {
    lng int
    lat int
}
type person struct {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>asm</p><div class="language-asm line-numbers-mode" data-ext="asm" data-title="asm"><pre class="language-asm"><code>#include &quot;textflag.h&quot;
...
TEXT ·readStruct(SB), NOSPLIT, $0-64
    ...
    MOVQ AX, ret3+56(FP)
    RET
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>go</p><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>asm</p><p>为<code>mapassign_fast64</code>的参数准备</p><div class="language-asm line-numbers-mode" data-ext="asm" data-title="asm"><pre class="language-asm"><code>// t *maptype
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>获取 goroutine id</p><p>go</p><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">package</span> goroutineid
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>go_tls.h</p><div class="language-asm line-numbers-mode" data-ext="asm" data-title="asm"><pre class="language-asm"><code>#ifdef GOARCH_arm
#define LR R14
#endif
...
TEXT ·GetGoID(SB), NOSPLIT, $0-8
	...
	MOVQ AX, ret+0(FP) //
	RET
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="simd" tabindex="-1"><a class="header-anchor" href="#simd"><span>SIMD</span></a></h3>`,88),m={href:"https://cch123.gitbooks.io/duplicate/content/part3/performance/simd-instruction-class.html",target:"_blank",rel:"noopener noreferrer"},b=i(`<ul><li>128 位的 XMM0~XMM31 寄存器。</li><li>256 位的 YMM0~YMM31 寄存器。</li><li>512 位的 ZMM0~ZMM31 寄存器。</li></ul><p>这些寄存器的关系，类似 RAX，EAX，AX 之间的关系。指令方面可以同时对多组数据进行移动或者计算，例如:</p><ul><li>movups : 把 4 个不对准的单精度值传送到 xmm 寄存器或者内存</li><li>movaps : 把 4 个对准的单精度值传送到 xmm 寄存器或者内存</li></ul><p>上述指令，当我们将数组作为函数的入参时有很大概率会看到</p><p>go</p><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>asm</p><div class="language-asm" data-ext="asm" data-title="asm"><pre class="language-asm"><code>0x001d 00029 (arr_par.go:10)    MOVQ    &quot;&quot;.statictmp_0(SB), AX
...
</code></pre></div><p>编译器在某些情况下已经考虑到了性能问题，帮助我们使用 SIMD 指令集来对数据搬运进行了优化。</p><h3 id="demo" tabindex="-1"><a class="header-anchor" href="#demo"><span>demo</span></a></h3><p>main.go</p><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>go tool compile <span class="token parameter variable">-N</span> <span class="token parameter variable">-l</span> <span class="token parameter variable">-S</span> main.go <span class="token operator">&gt;</span> main.tool.compile
</code></pre></div><p>main.tool.compile</p><div class="language-asm line-numbers-mode" data-ext="asm" data-title="asm"><pre class="language-asm"><code>&quot;&quot;.addInt STEXT size=177 args=0x18 locals=0x20 funcid=0x0
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,15);function g(k,h){const a=l("ExternalLinkIcon");return d(),c("div",null,[r,n("p",null,[n("a",p,[s("https://go.xargin.com/docs/assembly/assembly/"),e(a)])]),v,n("p",null,[n("a",m,[s("SIMD"),e(a)]),s(" 是 Single Instruction, Multiple Data 的缩写，在 Intel 平台上的 SIMD 指令集先后为 SSE，AVX，AVX2，AVX512，这些指令集引入了标准以外的指令，和宽度更大的寄存器，例如:")]),b])}const S=t(u,[["render",g],["__file","plan9.html.vue"]]),A=JSON.parse('{"path":"/tech/asm/plan9.html","title":"plan9","lang":"zh-CN","frontmatter":{"title":"plan9","date":"2023-06-14T05:07:00.000Z","category":"编译","tag":["go","compile"],"description":"基本指令 https://go.xargin.com/docs/assembly/assembly/ MOV 数据搬运，赋值 LEA 取址 & TEST CMP 比较 JLS （ jump less ）小于时跳转 JMP（ jump ）无条件跳转 JEQ（ jump equal ）等于时跳转 SUB 相减，结果保存到目标操作数 ADD 相加，结果保存到...","head":[["meta",{"property":"og:url","content":"https://blog.ruizhou.cf/tech/asm/plan9.html"}],["meta",{"property":"og:site_name","content":"rz blog"}],["meta",{"property":"og:title","content":"plan9"}],["meta",{"property":"og:description","content":"基本指令 https://go.xargin.com/docs/assembly/assembly/ MOV 数据搬运，赋值 LEA 取址 & TEST CMP 比较 JLS （ jump less ）小于时跳转 JMP（ jump ）无条件跳转 JEQ（ jump equal ）等于时跳转 SUB 相减，结果保存到目标操作数 ADD 相加，结果保存到..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-01-23T17:40:01.000Z"}],["meta",{"property":"article:author","content":"ruizhou"}],["meta",{"property":"article:tag","content":"go"}],["meta",{"property":"article:tag","content":"compile"}],["meta",{"property":"article:published_time","content":"2023-06-14T05:07:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-01-23T17:40:01.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"plan9\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2023-06-14T05:07:00.000Z\\",\\"dateModified\\":\\"2024-01-23T17:40:01.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"ruizhou\\",\\"url\\":\\"https://blog.ruizhou.cf\\"}]}"]]},"headers":[{"level":2,"title":"基本指令","slug":"基本指令","link":"#基本指令","children":[{"level":3,"title":"栈调整","slug":"栈调整","link":"#栈调整","children":[]},{"level":3,"title":"数据计算","slug":"数据计算","link":"#数据计算","children":[]},{"level":3,"title":"内存操作","slug":"内存操作","link":"#内存操作","children":[]},{"level":3,"title":"条件调转","slug":"条件调转","link":"#条件调转","children":[]}]},{"level":2,"title":"寄存器","slug":"寄存器","link":"#寄存器","children":[{"level":3,"title":"通用寄存器","slug":"通用寄存器","link":"#通用寄存器","children":[]},{"level":3,"title":"伪寄存器","slug":"伪寄存器","link":"#伪寄存器","children":[]},{"level":3,"title":"变量声明","slug":"变量声明","link":"#变量声明","children":[]}]},{"level":2,"title":"函数声明","slug":"函数声明","link":"#函数声明","children":[]},{"level":2,"title":"栈结构","slug":"栈结构","link":"#栈结构","children":[{"level":3,"title":"argsize 和 framsize","slug":"argsize-和-framsize","link":"#argsize-和-framsize","children":[{"level":4,"title":"argsize","slug":"argsize","link":"#argsize","children":[]},{"level":4,"title":"framesize","slug":"framesize","link":"#framesize","children":[]},{"level":4,"title":"地址运算","slug":"地址运算","link":"#地址运算","children":[]}]},{"level":3,"title":"伪寄存器 SP 、伪寄存器 FP 和硬件寄存器 SP","slug":"伪寄存器-sp-、伪寄存器-fp-和硬件寄存器-sp","link":"#伪寄存器-sp-、伪寄存器-fp-和硬件寄存器-sp","children":[]},{"level":3,"title":"其他","slug":"其他","link":"#其他","children":[]},{"level":3,"title":"SIMD","slug":"simd","link":"#simd","children":[]},{"level":3,"title":"demo","slug":"demo","link":"#demo","children":[]}]}],"git":{"createdTime":1706031601000,"updatedTime":1706031601000,"contributors":[{"name":"liuruizhou","email":"liuruizhou@bilibili.com","commits":1}]},"readingTime":{"minutes":20.89,"words":6266},"filePathRelative":"tech/asm/plan9.md","localizedDate":"2023年6月14日","excerpt":"","autoDesc":true}');export{S as comp,A as data};
