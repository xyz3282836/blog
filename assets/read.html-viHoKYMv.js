...
</code></pre></div><p>上面的命令可以逐行读取文件，每一行存入变量 <code>line</code>，打印出来以后再读取下一行。</p>`,34),p=[t];function l(c,i){return a(),n("div",null,p)}const u=s(o,[["render",l],["__file","read.html.vue"]]);export{u as default};
