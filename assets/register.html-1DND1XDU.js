import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as o,o as l,c as u,b as s,d as n,e as a,w as c,a as p}from"./app-nhrEVZ_Y.js";const d={},r={id:"注册小程序",tabindex:"-1"},k=s("a",{class:"header-anchor",href:"#注册小程序","aria-hidden":"true"},"#",-1),v=s("p",null,[n("每个小程序都需要在 "),s("code",null,"app.js"),n(" 中调用 "),s("code",null,"App"),n(" 方法注册小程序示例，绑定生命周期回调函数、错误监听和页面不存在监听函数等。")],-1),m=p(`<div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// app.js</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这种创建方式非常类似于 自定义组件 ，可以像自定义组件一样使用 <code>behaviors</code> 等高级特性。</p><p>具体细节请阅读 <code>Component</code> 构造器 章节。</p>`,6);function y(j,w){const t=o("Badge"),e=o("RouterLink");return l(),u("div",null,[s("h2",r,[k,n(" 注册小程序 "),a(t,{text:"重要",type:"error"})]),v,s("p",null,[n("详细的参数含义和使用请参考 "),a(e,{to:"/code/mini-app/guide/service/app.html"},{default:c(()=>[n("App 参考文档")]),_:1}),n("。")]),m,s("h3",b,[h,n(" 使用 Page 构造器注册页面 "),a(t,{text:"重要",type:"error"})]),g,s("p",null,[n("详细的参数含义和使用请参考 "),a(e,{to:"/code/mini-app/guide/service/page.html"},{default:c(()=>[n("Page 参考文档")]),_:1}),n("。")]),s("h3",f,[_,n(" 使用 Component 构造器构造页面 "),a(t,{text:"初学无需了解",type:"grey"})]),x])}const D=i(d,[["render",y],["__file","register.html.vue"]]);export{D as default};
