import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as o,o as l,c as u,b as s,d as n,e as a,w as c,a as p}from"./app-dG921_XJ.js";const d={},r={id:"注册小程序",tabindex:"-1"},k=s("a",{class:"header-anchor",href:"#注册小程序","aria-hidden":"true"},"#",-1),v=s("p",null,[n("每个小程序都需要在 "),s("code",null,"app.js"),n(" 中调用 "),s("code",null,"App"),n(" 方法注册小程序示例，绑定生命周期回调函数、错误监听和页面不存在监听函数等。")],-1),m=p(`<div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// app.js</span>
