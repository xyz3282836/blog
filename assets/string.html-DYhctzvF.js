import{_ as a}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as n,b as e,d as o,a as p}from"./app-CUneG6_F.js";const t={},l=o("p",null,"本章介绍 Bash 字符串操作的语法。",-1),c=p(`<h2 id="字符串的长度" tabindex="-1"><a class="header-anchor" href="#字符串的长度"><span>字符串的长度</span></a></h2><p>获取字符串长度的语法如下。</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token variable">\${<span class="token operator">#</span>varname}</span>
...
$ <span class="token builtin class-name">echo</span> <span class="token variable">\${foo<span class="token operator">,,</span>}</span>
hello
</code></pre></div>`,83);function r(i,d){return s(),n("div",null,[l,e(" more "),c])}const g=a(t,[["render",r],["__file","string.html.vue"]]),b=JSON.parse('{"path":"/linux/bash/string.html","title":"字符串操作","lang":"zh-CN","frontmatter":{"date":"2020-05-04T00:00:00.000Z","title":"字符串操作","icon":"string","author":"阮一峰","category":"Linux","tag":["Bash"],"copyright":"本教程采用<a href=\\"https://creativecommons.org/licenses/by-sa/3.0/deed.zh\\" rel=\\"noopener noreferrer\\" target=\\"_blank\\">知识共享 署名-相同方式共享 3.0协议</a>","description":"本章介绍 Bash 字符串操作的语法。 字符串的长度 获取字符串长度的语法如下。 下面是一个例子。 大括号 {} 是必需的，否则 Bash 会将 $# 理解成脚本的参数个数，将变量名理解成文本。 上面例子中，Bash 将 $# 和 myvar 分开解释了。 子字符串 字符串提取子串的语法如下。 上面语法的含义是返回变量 $varname 的子字符串，从...","head":[["meta",{"property":"og:url","content":"https://blog.ruizhou.cf/linux/bash/string.html"}],["meta",{"property":"og:site_name","content":"rz blog"}],["meta",{"property":"og:title","content":"字符串操作"}],["meta",{"property":"og:description","content":"本章介绍 Bash 字符串操作的语法。 字符串的长度 获取字符串长度的语法如下。 下面是一个例子。 大括号 {} 是必需的，否则 Bash 会将 $# 理解成脚本的参数个数，将变量名理解成文本。 上面例子中，Bash 将 $# 和 myvar 分开解释了。 子字符串 字符串提取子串的语法如下。 上面语法的含义是返回变量 $varname 的子字符串，从..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-01-19T19:40:22.000Z"}],["meta",{"property":"article:author","content":"阮一峰"}],["meta",{"property":"article:tag","content":"Bash"}],["meta",{"property":"article:published_time","content":"2020-05-04T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-01-19T19:40:22.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"字符串操作\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2020-05-04T00:00:00.000Z\\",\\"dateModified\\":\\"2024-01-19T19:40:22.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"阮一峰\\"}]}"]]},"headers":[{"level":2,"title":"字符串的长度","slug":"字符串的长度","link":"#字符串的长度","children":[]},{"level":2,"title":"子字符串","slug":"子字符串","link":"#子字符串","children":[]},{"level":2,"title":"搜索和替换","slug":"搜索和替换","link":"#搜索和替换","children":[{"level":3,"title":"字符串头部的模式匹配","slug":"字符串头部的模式匹配","link":"#字符串头部的模式匹配","children":[]},{"level":3,"title":"字符串尾部的模式匹配","slug":"字符串尾部的模式匹配","link":"#字符串尾部的模式匹配","children":[]},{"level":3,"title":"任意位置的模式匹配","slug":"任意位置的模式匹配","link":"#任意位置的模式匹配","children":[]}]},{"level":2,"title":"改变大小写","slug":"改变大小写","link":"#改变大小写","children":[]}],"git":{"createdTime":1705693222000,"updatedTime":1705693222000,"contributors":[{"name":"zhou","email":"ruizhou@163.com","commits":1}]},"readingTime":{"minutes":6.35,"words":1906},"filePathRelative":"linux/bash/string.md","localizedDate":"2020年5月4日","excerpt":"<p>本章介绍 Bash 字符串操作的语法。</p>\\n","copyright":{"author":"阮一峰"},"autoDesc":true}');export{g as comp,b as data};
