import{_ as a}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as n,f as e,b as o,a as p}from"./app-BGIZeecH.js";const t={},c=o("p",null,"本章介绍 Bash 字符串操作的语法。",-1),l=p(`<h2 id="字符串的长度" tabindex="-1"><a class="header-anchor" href="#字符串的长度"><span>字符串的长度</span></a></h2><p>获取字符串长度的语法如下。</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token variable">\${<span class="token operator">#</span>varname}</span>
...
$ <span class="token builtin class-name">echo</span> <span class="token variable">\${foo<span class="token operator">,,</span>}</span>
hello
</code></pre></div>`,83);function r(d,i){return s(),n("div",null,[c,e(" more "),l])}const b=a(t,[["render",r],["__file","string.html.vue"]]);export{b as default};
