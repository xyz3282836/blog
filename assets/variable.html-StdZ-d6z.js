...
</code></pre></div><p>上面例子中，<code>let</code> 声明了两个变量 <code>v1</code> 和 <code>v2</code>，其中 <code>v2</code> 等于 <code>v1++</code>，表示先返回 <code>v1</code> 的值，然后 <code>v1</code> 自增。</p><p>这种语法支持的运算符，参考《Bash 的算术运算》一章。</p>`,158);function t(i,r){return s(),e("div",null,[p,n(" more "),d])}const v=a(l,[["render",t],["__file","variable.html.vue"]]);export{v as default};
