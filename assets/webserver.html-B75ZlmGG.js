import{_ as a}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as s,a as e}from"./app-D1-vkFMn.js";const p={},t=e(`<h1 id="网络服务器相关" tabindex="-1"><a class="header-anchor" href="#网络服务器相关" aria-hidden="true">#</a> 网络服务器相关</h1><h2 id="ftp" tabindex="-1"><a class="header-anchor" href="#ftp" aria-hidden="true">#</a> ftp</h2><h3 id="vsftpd" tabindex="-1"><a class="header-anchor" href="#vsftpd" aria-hidden="true">#</a> vsftpd</h3><ul><li><p>安装</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">apt-get</span> <span class="token function">install</span> vsftpd <span class="token function">ftp</span>
...
</code></pre></div><div class="hint-container tip"><p class="hint-container-title">提示</p><p>如果报了 permission limitted 的错误，说明 php 没法访问 html 文件夹，修改配置的 html 文件夹权限即可。</p></div>`,24),c=[t];function i(o,l){return n(),s("div",null,c)}const u=a(p,[["render",i],["__file","webserver.html.vue"]]);export{u as default};
